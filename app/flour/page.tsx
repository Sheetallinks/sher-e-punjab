...
import { floursProducts } from "@/lib/products-data"
...
export default function FlourPage() {
  return (
    <div className="relative">
      ...
      <HeroSection
        title="Premium Flours"
        subtitle="High-quality flours for authentic Indian cooking and baking"
      ...
      <section className="py-16 bg-gradient-to-b from-background to-muted/30 relative">
        <div className="container mx-auto px-4">
          <div className="mb-12 animate-fade-in">
            <h2 className="text-4xl font-serif font-bold mb-4 text-balance">Our Flour Selection</h2>
            <p className="text-lg text-muted-foreground text-pretty">
              Premium quality flours milled fresh to bring authentic taste to your kitchen
            </p>
          </div>

          <ProductGrid products={floursProducts} />
        </div>
      </section>
    </div>
  )
